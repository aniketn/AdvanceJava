...
public class ValidPath {
    ...
    private static void dfs(int i, int j, int A, int B, int D, ArrayList<Integer> E, ArrayList<Integer> F) {
    ...
    private static boolean isValid(int i, int j, int A, int B, int D, ArrayList<Integer> E, ArrayList<Integer> F) {
