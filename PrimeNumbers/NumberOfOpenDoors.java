...
/*Problem Description
        Given an integer A, which denotes the number of doors in a row numbered 1 to A. All the doors are closed
        initially.
        A person moves to and fro, changing the states of the doors as follows: the person opens a door that is
        already closed and closes a door that is already opened.
...
public class NumberOfOpenDoors {
    /*Mathematically every factor has its counter part
    eg: if n=10; 2 has 5 & 1 has 10
    from that case, we can say only perfect squares have counter part OR counterpart is the same integer.
            eg: if n=25; 5 has 5 which is same. 1 has 25;
    So we have to return the count of numbers having odd factors i.e. perfect squares*/
