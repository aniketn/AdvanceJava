...
/*Problem Description
        ...
        Heap has to be a complete binary tree ( A complete binary tree is a
        binary tree in which every level, except possibly the last, is completely filled,
        and all nodes are as far left as possible.)
        Every node is greater than all its children.
        NOTE: If you want to know more about Heaps, please visit this link.
...
public class WaysToFormMaxHeap {
    ...
    public static int findleftSubtreeNodesCount(int n, int height){//n is total number of nodes
    ...
    public static int findNCR(int A, int B){
        if(A == B)
            return 1;
